...
class TourMapPage extends StatefulWidget {
  @override
  _TourMapPageState createState() => _TourMapPageState();
}
...
class _TourMapPageState extends State<TourMapPage> {
  ...
  init() {
    if (ScopedModel.of<MapModel>(context).getLocation) {
      setState(() {
        locationRetrieved = true;
        latitude = ScopedModel.of<MapModel>(context).lat;
        longitude = ScopedModel.of<MapModel>(context).lng;
      });
    }
  }
  ...
  Future<void> _updateLocation() async {
    ...
    ScopedModel.of<MapModel>(context)
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          Container(
              ...
              child: Image.asset('assets/icons/map.png', scale: 2.5,)),
          SizedBox(
            width: 10,
          ),
          Text('Peta Wisata')
